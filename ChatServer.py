...
def handle_client(conn):
    ...
    while conn_open:
        ...
        # if text_file == 0:  # I was attempting to implement larger file shares
        if to_client != 'everyone':
            ...
            # message_to_send = '{}:{}:{}:[{}]'.format(text_file, to_client, from_client, message)
...
def start_server():
    ...
    while True:
        ...
        # connection.send('Please input your name to start.\r\n'.encode(FORMAT))
        ...
        connection.send('Remember to select who you want the message to be sent to!\r\n'
                        'If the message is in "[]", than you received a private message!'.encode(FORMAT))
